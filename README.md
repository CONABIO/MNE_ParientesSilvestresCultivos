...
Juan M. Barrios  <jbarrios@conabio.gob.mx> para generar los modelos de nicho ecologico de algunos de los 
parientes silvestres de cultivo de Mesoamerica (PSCM).

El codigo `MNE.R` utiliza las bases de ocurrencia de PSCM en formato .csv descargadas de http://www.snib.mx/datos y de
